...
<img src='wp-admin/other_images/$manufacturer_image' width='20px' >&nbsp;
...
$p_cat_image = "<img src='wp-admin/other_images/$p_cat_image' width='20'> &nbsp;";
...
$cat_image = "<img src='wp-admin/other_images/$cat_image' width='20'>&nbsp;";
